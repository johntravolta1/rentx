...
categoriesRoutes.post("/", _ensureAuthentication.ensureAuthenticated, _ensureAdmin.ensureAdmin, createCategoryController.handle);
categoriesRoutes.get("/", listCategoriesController.handle);
categoriesRoutes.post("/import", upload.single("file"), _ensureAuthentication.ensureAuthenticated, _ensureAdmin.ensureAdmin, importCategoryController.handle);