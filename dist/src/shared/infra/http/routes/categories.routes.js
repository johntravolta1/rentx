...
const ListCategoriesController_1 = require("../../../../modules/cars/useCases/listCategory/ListCategoriesController");
...
categoriesRoutes.post("/", ensureAuthentication_1.ensureAuthenticated, ensureAdmin_1.ensureAdmin, createCategoryController.handle);
categoriesRoutes.get("/", listCategoriesController.handle);
categoriesRoutes.post("/import", upload.single("file"), ensureAuthentication_1.ensureAuthenticated, ensureAdmin_1.ensureAdmin, importCategoryController.handle);
