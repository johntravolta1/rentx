...
class CreateSpecificationsCars1650335571528 {
    ...
    down(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            yield queryRunner.dropForeignKey('specification_cars', 'FKSpecificationCar');
            yield queryRunner.dropForeignKey('specification_cars', 'FKCarSpecification');
            yield queryRunner.dropTable('specification_cars');
        });
    }
}
